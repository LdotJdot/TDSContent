...
namespace DotMaysWind.Office.summary
{
    public class SummaryInformation
    {
        ...
        public SummaryInformation(uint propertyID, uint propertyType, byte[] data)
        {
            _propertyID = (SummaryInformationType)propertyID;
            ...
            else if (propertyType == 0x40) _data = DateTime.FromFileTime(BitConverter.ToInt64(data, 0));
        }
        ...
        /// <param name="data">属性数据</param>
        public SummaryInformation(uint propertyID, uint propertyType, int codePage, byte[] data)
        {
            _propertyID = (SummaryInformationType)propertyID;
